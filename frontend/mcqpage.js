...
$('#next').click(function (e) {
  ...
  if (jsq.currentque >= totalque) {
    ...
    const quizResults = {
      ...
      user:userId || "userId_default"
      // You can include additional data such as question-level results
    };

    fetch('/submitQuizResults', {
      method: 'POST',
      headers: {
    ...
    .then(data => {
      console.log('Quiz results successfully sent:', data);
    })
    .catch((error) => {
